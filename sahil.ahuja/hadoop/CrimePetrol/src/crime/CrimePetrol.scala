...
object CrimePetrol {
  def main(args: Array[String]) = {
   ...
   // var k =  parserdd.map(x => (x.block_addr,x.fbicode))
  ...
  def parse(row: String): description = {
   ...
   // if (fields(15) == "") fields(15) = "0000000"
    //var x_co: Int = fields(15).toInt
    //if (fields(16) == "") fields(16) = "0000000"
    //var y_co: Int = fields(16).toInt
    var year: Int = fields(17).toInt
    var updateddate = fields(18)
    //if (fields(19) == "") fields(19) = "00.000000000"
    //var latitude: Double = fields(19).toDouble
    //if (fields(20) == "") fields(20) = "00.000000000"
    //var longitude: Double = fields(20).toDouble
    //if (fields(15) == "") fields(15) = "(00.000000000. 00.000000000)"
    //var location = fields(21)
